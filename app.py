...
years_data = pd.read_csv('MCI-Flight-status/Resources/years_data.csv')
months_data = pd.read_csv('MCI-Flight-status/Resources/months_data.csv')
dows_data = pd.read_csv('MCI-Flight-status/Resources\dows_data.csv')
carriers_data = pd.read_csv('MCI-Flight-status/Resources/airlines_data.csv')
X = pd.read_csv('MCI-Flight-status/Resources/X.csv')
